...
string[] Research_and_Developmentt = { "Reseach_and_Design_Department_Head", "Senior_Research_Software_Development_Engineer", " Quantum_Software_Researcher", "Reseach_and_Design_Engineer", };
string[] Kitchen = { "Kitchen_Manager", "Executive_Chef", " Executive_Sous_Chef", "Pastry_Sous_Chef", "Baker", "Sous_Chef", "Saucier", "Grillardin", "Garde_Manger", "Friturier", "Chef_de_Partie", "Chef_de_Tournant", "Entremetier", "Commis_1", "Commis_2", "Commis_3", "Kitchen_Porter", "Esculelerie", "Trainee_1","Trainee_2", };
string[] Cleaning = { "Cleaning_Team_Manager", " Cleaning_Team_Supervisor", "Cleaning_Team_Officer", "", };
